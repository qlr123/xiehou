...
export default {
  data() {
    return {
      ...
      images1: [
        {
          img:
            "http://img1.imgtn.bdimg.com/it/u=1329921053,123283718&fm=26&gp=0.jpg",
          job: "事业单位"
        },
        {
          img:
            "http://bpic.588ku.com/element_origin_min_pic/18/01/02/feb4853429af8d72ff604c5203ebf9b5.jpg%21/fwfh/804x804/quality/90/unsharp/true/compress/true",
          job: "商业人员"
        },
        {
          img: "http://pic.90sjimg.com/design/00/72/76/84/591e687c60f45.png",
          job: "教师"
        },
        {
          img:
            "https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=3749555205,134408843&fm=26&gp=0.jpg",
          job: "医生"
        },
        {
          img:
  ...
  mounted() {
    axios({
      method: "get",
      url: "http://39.97.226.25:8082/user/showDynamic"
    }).then(res => {
      this.info = res.data;
    });
  },
