<template>
    <div class="gz-box">
        ...
        <van-tab title="关注我的"> 
            <div class="item-box" v-for="item in values">
                <div class="img">
        ...
        <van-tab title="我关注的">
            <div class="item-box" v-for="item in values2">
                <div class="img">
                    <img :src="item.headportrait" alt="" width="90px" height="90px">
                </div>
                <div class="name">姓名:{{item.username}}</div>
    ...
    methods:{
        addgzs(data){
            ...
            axios({
                ...
                data:qs.stringify({attention:this.$store.state.userID,focused:data.srcElement.id}),
            }).then((data)=>{
                console.log(data)
