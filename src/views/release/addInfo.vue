<template>
    <div>
        ...
        <van-row type="flex" justify="center" v-if="nowshow" >
            ...
            <van-col span="6"><van-button type="warning" style="">发布信息</van-button></van-col>
...
export default {
    ...
    mounted(){
        ...
        if(this.$store.state.favoredType!=null) {
            ...
            this.minMaxHeight = this.$store.state.favoredType.maxHeight +"cm至" + this.$store.state.favoredType.minHeight+"cm"
