...
<<<<<<< HEAD
  <div
    style="background:linear-gradient(to bottom right, #ffa4d0, #fb7379);width:375px;height:1236px;
"
  >
    <van-nav-bar title="活动" left-arrow :fixed="true" @click-left="onClickLeft" />
    <van-cell-group
      style="border:1px solid gray;margin-top:15px;margin:0 auto;background: linear-gradient(to bottom right, #ffa4d0, #fb7379);
 position:relative"
    >
      <van-image width="327px" height="220px" src="https://img.yzcdn.cn/vant/cat.jpeg" />
      <van-cell-group
        style="position:absolute;left:13px;bottom:0px;background: linear-gradient(to bottom right, #ffa4d0, #fb7379)"
      >
        <van-image width="45px" height="45px" src="https://img.yzcdn.cn/vant/cat.jpeg" />
      </van-cell-group>
      <van-cell-group
...
<van-cell-group style="width:135px;margin-left:70px;margin-top:1.5px;background: linear-gradient(to bottom right, #ffa4d0, #fb7379)">
  <van-field v-model="value" placeholder="联系方式" style="background: linear-gradient(to bottom right, #ffa4d0, #fb7379)" />
</van-cell-group>
<span style="float:right;margin-top:10px;background: linear-gradient(to bottom right, #ffa4d0, #fb7379)">已有{{num}}人报名</span>
</van-cell-group>
<van-button type="primary" @click="showPopup" style="border:1px solid gray;float:left;margin:0.3rem 0 0 0.3rem;background: linear-gradient(to bottom right, #ffa4d0, #fb7379)">
  活动详情
</van-button>
<van-popup v-model="show"></van-popup>
<van-cell-group style="margin-top:3.5rem;background: linear-gradient(to bottom right, #ffa4d0, #fb7379)">
<van-field
  style="background: linear-gradient(to bottom right, #ffa4d0, #fb7379)"
    v-model="value1"
   disabled
...
>>>>>>> d90ba59f012c3341a716436309706ac58729be4b
</template>
<script>
import "lib-flexible";
